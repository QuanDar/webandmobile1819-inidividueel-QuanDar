            ...
            <div>
                ...
                {messages.map((message, index) =>
                    <CardWrapper key={index}>
                        <Message id={message.id} isAdmin={isAdmin} role={this.props.role} content={message.content} deleteMessageClick={this.deleteMessageClick} upvoteClick={this.upvoteClick} downvoteClick={this.downvoteClick} upvotes={message.upVotes} downvotes={message.downVotes} date={message.date} category={message.category}/>
